...
app.get('/configuration', function (request, response) {
  ...
  const filename = '/home/centria/projects/mikamatkaselka/OCR-Tehtava_Mika_Matkaselka/configuration.xml';
...
app.get('/image', function (request, response) {
  ...
  const filename = '/home/centria/projects/mikamatkaselka/RESTAPI/Responses/Image.jpg';
  fileSystem.exists(filename,  function(exists) {
    if(exists) {
...
app.get('/result', function (request, response) {
  ...
  const filename = '/home/centria/projects/mikamatkaselka/RESTAPI/Responses/result.xml'; 
  fileSystem.exists(filename,  function(exists) {
    if(exists) {
      const fileContent = fileSystem.readFileSync(filename, 'utf8');
      response.set('Content-Type', 'text/xml');
